...
app.post('/api/clock', handleClockPost);
...
const handleImportBatches = (req, res) => {
  ...
  for (const rawItem of items) {
    ...
    const receivedDate = parseMessyDate(rawItem.received_date) || todayUtc();
...
const handleOutboxDelete = (req, res) => { outbox.length = 0; res.json({ cleared: true, outbox: [] }); };

app.get('/outbox', handleOutboxGet);
app.get('/api/outbox', handleOutboxGet);
app.delete('/outbox', handleOutboxDelete);
app.delete('/api/outbox', handleOutboxDelete);
